...
export const cards: CardProps[] = [
	{ image: accra, location: "Accra", href: "#" },
	{ image: elminaCastle, location: "Elmina Castle", href: "#" },
	{ image: lakeVolta, location: "Lake Volta", href: "#" },
];
...
function Card({ image, location, href = "#" }: CardProps) {
	return (
		<Link href={href}>
			<div className="max-w-md rounded-lg h-52 group relative overflow-hidden rounded-b-none cursor-pointer mx-auto">
